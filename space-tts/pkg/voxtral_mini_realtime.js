/* @ts-self-types="./voxtral_mini_realtime.d.ts" */
...
export class TekkenTokenizerWasm {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        TekkenTokenizerWasmFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_tekkentokenizerwasm_free(ptr, 0);
    }
    /**
    ...
    encode(text) {
        ...
        const ret = wasm.tekkentokenizerwasm_encode(this.__wbg_ptr, ptr0, len0);
    ...
    constructor(json) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.tekkentokenizerwasm_new(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        TekkenTokenizerWasmFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
if (Symbol.dispose) TekkenTokenizerWasm.prototype[Symbol.dispose] = TekkenTokenizerWasm.prototype.free;
...
export class VoxtralQ4 {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        VoxtralQ4Finalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_voxtralq4_free(ptr, 0);
    }
    /**
    ...
    appendModelShard(shard) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.voxtralq4_appendModelShard(this.__wbg_ptr, ptr0, len0);
    }
    /**
     ...
     */
    getSampleRate() {
        const ret = wasm.voxtralq4_getSampleRate(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    isReady() {
        const ret = wasm.voxtralq4_isReady(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    loadModel(gguf_bytes, tokenizer_json) {
        ...
        const ret = wasm.voxtralq4_loadModel(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        if (ret[1]) {
     ...
     * @param {string} tokenizer_json
     */
    loadModelFromShards(tokenizer_json) {
        const ptr0 = passStringToWasm0(tokenizer_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.voxtralq4_loadModelFromShards(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    constructor() {
        const ret = wasm.voxtralq4_new();
        this.__wbg_ptr = ret >>> 0;
        VoxtralQ4Finalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    transcribe(audio) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.voxtralq4_transcribe(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
}
if (Symbol.dispose) VoxtralQ4.prototype[Symbol.dispose] = VoxtralQ4.prototype.free;
...
export class VoxtralTts {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        VoxtralTtsFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_voxtraltts_free(ptr, 0);
    }
    /**
     * Append a GGUF shard to the internal buffer.
     * @param {Uint8Array} shard
    ...
    appendModelShard(shard) {
        const ptr0 = passArray8ToWasm0(shard, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.voxtraltts_appendModelShard(this.__wbg_ptr, ptr0, len0);
    }
    /**
     ...
     */
    isReady() {
        const ret = wasm.voxtraltts_isReady(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    loadModelFromShards() {
        const ret = wasm.voxtraltts_loadModelFromShards(this.__wbg_ptr);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    loadVoice(voice_bytes) {
        const ptr0 = passArray8ToWasm0(voice_bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.voxtraltts_loadVoice(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    constructor() {
        const ret = wasm.voxtraltts_new();
        this.__wbg_ptr = ret >>> 0;
        VoxtralTtsFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     */
    synthesize(token_ids, max_frames) {
        const ptr0 = passArray32ToWasm0(token_ids, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.voxtraltts_synthesize(this.__wbg_ptr, ptr0, len0, max_frames);
        return ret;
    }
}
if (Symbol.dispose) VoxtralTts.prototype[Symbol.dispose] = VoxtralTts.prototype.free;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./voxtral_mini_realtime_bg.js": import0,
    };
}
...
const TekkenTokenizerWasmFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_tekkentokenizerwasm_free(ptr >>> 0, 1));
const VoxtralQ4Finalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_voxtralq4_free(ptr >>> 0, 1));
const VoxtralTtsFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_voxtraltts_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('voxtral_mini_realtime_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
